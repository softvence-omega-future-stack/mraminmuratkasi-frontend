...
interface Notification {
  ...
  avatar: string;
  type?: "message" | "other";
  userId: string; // Added type for redirection logic
}
...
const NotificationModalForAdmin: React.FC<NotificationModalProps> = ({
  open,
  onClose,
  notifications,
  onDelete,
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      className="p-1 rounded-full hover:bg-red-50 text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity disabled:opacity-50 cursor-pointer"
                      title="Delete"
                    >
                      {deletingId === notif.id ? (
                    ...
                    <button
                      className="p-1 rounded-full hover:bg-red-50 text-gray-400 hover:text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity disabled:opacity-50 cursor-pointer"
                      onClick={() => handleSelectUser(notif.userId)}
                    >
...
export default NotificationModalForAdmin;
