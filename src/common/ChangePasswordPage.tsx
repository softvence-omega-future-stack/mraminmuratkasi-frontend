...
export default function ChangePasswordPage() {
  ...
  return (
    <ClientDashboardLayout>
      <div className="p-6">
        <div className="bg-white rounded-lg shadow p-8 max-w-4x mx-auto">
          ...
          {/* Success Section */}
          {success && (
            <div className="flex justify-between items-start bg-green-50 border border-green-200 rounded-md mb-6">
              <div className="px-4 py-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 py-6 ${
                    errors.currentPassword ? errorInputStyle : ""
                  }`}
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-10 pr-10 py-6 ${
                    errors.newPassword ? errorInputStyle : ""
                  }`}
                />
                <button
                  type="button"
